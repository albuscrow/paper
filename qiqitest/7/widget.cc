...
#define DEFAULT_OPEN
	...
	//QString file_name(tr("/home/cym/teapot/teapot.obj"));	int u_seg = 5; int v_seg = 5;
	//QString file_name(tr("/home/cym/teapot/teapot_5_5_cym.obj"));	int u_seg = 5; int v_seg = 5;
	QString file_name(tr("/home/cym/teapot/teapot_10_10_cym.obj")); int u_seg = 10; int v_seg = 10;

	//QString file_name2(tr("/home/cym/teapot/teapot_10_10.obj"));
	//QString file_name2(tr("/home/cym/teapot/teapot_100_100.obj"));
	//QString file_name2(tr("/home/cym/teapot/teapot_400_400.obj"));

	currentFileName = string(file_name.toLocal8Bit().data());
	//currentFileName2 = string(file_name2.toLocal8Bit().data());
	...
	//m_pCommonData->loadObj(currentFileName.c_str(), currentFileName2.c_str());
	m_pCommonData->loadObj(currentFileName.c_str(), u_seg, v_seg);
