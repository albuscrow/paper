...
set path=.,/usr/include,,,~/program/1,
set ruler
...
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,~/.indexer_files_tags/common_proj
set updatetime=2000
...
set shortmess=aoO
badd +1 view.cc
badd +1 ../looker/view.c
badd +1453 ../looker/view.cc
badd +1 view.h
badd +9 affd.fs
badd +12 affd.vs
badd +50 affd_line.fs
badd +1 affd_line.vs
badd +86 affd_truth.fs
badd +37 affd_truth.vs
badd +1 common_data.h
badd +482 widget.cc
badd +374 cuda_calc.cu
badd +1 ~/program/1/widget.h
badd +73 common_data.cc
badd +56 ~/win7.mkd
badd +23 obj_data.cc
badd +96 ~/program/1/obj_data.h
badd +40 obj_data.inl
badd +680 ~/program/backup/1_2014.05.05_已经完成多法向边的正确处理，下一步进行多法向边的几何效果的改进，改之前做个备份/cuda_calc.cu
badd +4 matrix_b_spline.cc
badd +1 ObjData.cc
argglobal
silent! argdel *
argadd view.cc
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 529 - ((16 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
529
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((19 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 222 - ((42 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
222
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 816 - ((23 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
816
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1999 - ((16 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1999
