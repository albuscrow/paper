...
\begin{figure}
	...
	\subfloat[][Improved Smooth FFD's Geometry errors]{
		\includegraphics[width=0.99\linewidth]{pic/error4.png}
	}\par
	\subfloat[][Improved Smooth FFD's Normal errors]{
		\includegraphics[width=0.99\linewidth]{pic/error5.png}
	}\par
\end{figure}
...
\begin{figure}
	...
	\subfloat[][Smooth FFD's Geometry errors]{
		\includegraphics[width=0.99\linewidth]{pic/error6.png}
	}\par
