...
\begin{figure}
    ...
    \subfloat[][Original model]{
		\includegraphics[width=0.49\linewidth]{pic/cube0.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot0.png}
	}\par
	\subfloat[][Improved Smooth FFD results of (a)]{
		\includegraphics[width=0.49\linewidth]{pic/cube2.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot2.png}
	}\par
...
\begin{figure}
	...
	\subfloat[][Smooth FFD results of (b)]{
		\includegraphics[width=0.49\linewidth]{pic/cube3.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot3.png}
	}\par
	\subfloat[][Accurate FFD results of (c)]{
		\includegraphics[width=0.49\linewidth]{pic/cube1.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot1.png}
	}\par
...
\begin{figure}
	...
	\subfloat[][Improved Smooth FFD's Geometry errors]{
		\includegraphics[width=0.49\linewidth]{pic/cube4.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot4.png}
	}\par
	\subfloat[][Improved Smooth FFD's Normal errors]{
		\includegraphics[width=0.49\linewidth]{pic/cube5.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot5.png}
	}\par
\end{figure}
...
\begin{figure}
	...
	\subfloat[][Smooth FFD's Geometry errors]{
		\includegraphics[width=0.49\linewidth]{pic/cube6.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot6.png}
	}\par
	\subfloat[][Smooth FFD's Normal errors]{
		\includegraphics[width=0.49\linewidth]{pic/cube7.png}
		\includegraphics[width=0.49\linewidth]{pic/teapot7.png}
	}
